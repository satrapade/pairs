...
the_pairs<-colnames(mc(pair_exposure,"JR[0-9]+"))
...
\newpage 
\section{
  \Sexpr{the_manager} Summary: 
  Recent performance of \underline{current} portfolio holdings, values shown in \sfrac{1}{10}th of a basis point
}
