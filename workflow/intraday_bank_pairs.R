...
append2log("intraday_bank_pairs: source utility_functions, sheet_bbg_functions")
source("https://raw.githubusercontent.com/satrapade/utility/master/utility_functions.R")
source("https://raw.githubusercontent.com/satrapade/utility/master/sheet_bbg_functions.R")


append2log("intraday_bank_pairs: fetch index memebers")
...
append2log("intraday_bank_pairs: save market_data/index_membership.csv ")
...
append2log("intraday_bank_pairs: fetch intraday for index members")
...
append2log("intraday_bank_pairs: save market_data/intraday_index_members.csv")
...
append2log("intraday_bank_pairs: compute intraday_open")
intraday_open<-local({
...
append2log("intraday_bank_pairs: compute intraday_high")
intraday_high<-local({
  res<-rename_colnames(dMcast(intraday,times~ticker,value.var="high"),"^ticker","")
  make_bar_matrix(res)
})

append2log("intraday_bank_pairs: compute intraday_low")
intraday_low<-local({
  res<-rename_colnames(dMcast(intraday,times~ticker,value.var="low"),"^ticker","")
  make_bar_matrix(res)
})

append2log("intraday_bank_pairs: compute intraday_perf")
...
append2log("intraday_bank_pairs: compute bar_intervals")
